...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    bio: "Destiny delivers flawless lash extensions and perfectly shaped brows. Her attention to detail ensures every client leaves feeling confident and beautiful.",
    experience: "6+ years",
  ...
  },
  {
    ...
    name: "Jasmine Carter",
    role: "Makeup Artist",
    bio: "Jasmine creates stunning makeup looks for weddings, events, and photoshoots. From soft glam to full beat, she makes every client camera-ready.",
    experience: "7+ years",
