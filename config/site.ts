export const siteConfig = {
  ...
  tagline: "Hair Braiding & Luxury Salon Suites for Rent",
  description:
    "Bb Salon SUITES offers expert hair braiding, lashes, eyebrows, makeup, and luxury salon suites for rent in Columbus, Ohio. Services from $100. Suites $150/week — all materials & Wi-Fi included.",
  ...
  email: "contact@bbsalonsuites.com",
  owner: "Bibiche",
  promotion: "$20 OFF your first service",
  address: {
    street: "2177 Livingston Ave",
    city: "Columbus",
    state: "OH",
    zip: "43209",
    country: "US",
    full: "2177 Livingston Ave, Columbus, OH 43209",
    coordinates: {
      lat: 39.945,
      lng: -82.948,
    },
